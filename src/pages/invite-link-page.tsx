...
import { usePublicWorkspaceInvitation } from '../features/invitations/use-invitations'

export function InviteLinkPage() {
  const token = useParams().token ?? null
  const invitation = usePublicWorkspaceInvitation(token)
          ...
          <Card>
            <CardContent className="p-8 text-center">
              ...
              <p className="mt-2 text-sm text-muted-foreground">
                This invitation link has expired or has already been answered.
              </p>
            </CardContent>
          </Card>
        </div>
        ...
        <Card>
          <CardContent className="p-8 text-center">
            ...
            <p className="mt-2 text-sm text-muted-foreground">
              ...
              {invitation.data.workspace_name}.
            </p>
